...
.. code-block:: python
    ...
    from webresource import css_markup
    from webresource import js_markup

    generated_css_markup = css_markup(development=False)
    generated_js_markup = js_markup(development=False)
